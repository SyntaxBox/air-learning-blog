      ...
      <div className="max-w-screen-xl grid gap-8 grid-cols-1 md:grid-cols-2 px-10 mx-auto">
        ...
        <div className="">
          <div>
            ...
            <input
              id="name"
              className="w-full bg-gray-50 border border-gray-200 text-gray-900 mt-2 p-3 rounded focus:outline-none focus:shadow-outline"
              type="text"
              placeholder=""
            />
          </div>
          ...
          <div className="mt-8">
            ...
            <textarea
              id="text"
              className="w-full h-[140px] bg-gray-50 border border-gray-200 text-gray-900 mt-2 p-3 rounded focus:outline-none focus:shadow-outline resize-none"
            ></textarea>
          </div>
          <div className="mt-8">
            <Link
